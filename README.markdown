...
You'll need [rvm](http://rvm.beginrescueend.com).  We're using Ruby 1.9.3-p125 and Rails 3.1, and there's an `.rvmrc` file which should help make sure you are using the right Ruby version.
